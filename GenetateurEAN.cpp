...
constexpr auto g_szWndTitle = R"(Code Barre 1.83 | (C)Patrice Waechter-Ebling 2019-2020 | Code: EAN 128 | 64bits | Windows 10)";
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,_In_opt_ HINSTANCE hPrevInstance,_In_ LPWSTR    lpCmdLine,_In_ int       nCmdShow){
 ...
 //   LoadString(hInstance, IDC_GENETATEUREAN, szWindowClass, MAX_LOADSTRING);
   ...
   HWND hDlg = CreateWindowEx(WS_EX_DLGMODALFRAME,szClassName, g_szWndTitle, WS_OVERLAPPED |  WS_CAPTION | WS_BORDER |WS_SYSMENU | WS_DLGFRAME,  CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, nullptr, nullptr, hInstance, nullptr);
